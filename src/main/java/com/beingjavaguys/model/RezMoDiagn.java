 ...
 */
@Entity
@Table(name = "rez_mo_diagn")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class RezMoDiagn implements Serializable {
    ...
    public RezMoDiagn(Long id) {
        this.id = id;
    }

    public RezMoDiagn(Long id, int numGiag) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RezMoDiagn)) {
            return false;
        }
        RezMoDiagn other = (RezMoDiagn) object;
    ...
    public String toString() {
        return "com.mycompany.genentyity2.RezMoDiagn[ id=" + id + " ]";
    }
